...
export default function CheckoutPage() {
  ...
  const [paymentMethod, setPaymentMethod] = useState<"stripe" | "overschrijving">("overschrijving")
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (paymentMethod === "overschrijving") {
        // Direct email verzenden voor overschrijving
        try {
                ...
                <div className="grid gap-4">
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <div className="font-semibold text-foreground">Online Betalen (Stripe)</div>
                      <p className="text-sm text-muted-foreground">Betaal direct en veilig met Bancontact, Creditcard, iDEAL etc.</p>
                    </div>
                  ...
                  {/* Overschrijving Option */}
                  <label 
                    className={`flex items-center gap-4 p-4 border rounded-lg cursor-pointer transition-colors ${
                      paymentMethod === "overschrijving" ? "border-primary bg-primary/5" : "border-border hover:border-primary/50"
                    }`}
                  >
                    <input 
                      type="radio" 
                    ...
                    />
                    <div className="flex-1">
                      <div className="font-semibold text-foreground">Bankoverschrijving</div>
                      <p className="text-sm text-muted-foreground">Maak het bedrag handmatig over op onze bankrekening na het plaatsen van de bestelling.</p>
                    </div>
                  </label>
                </div>
              </div>
